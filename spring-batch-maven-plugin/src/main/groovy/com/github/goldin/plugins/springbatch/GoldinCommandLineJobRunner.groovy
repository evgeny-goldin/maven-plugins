 ...
 *
 * <p>
 * Notice a property is available to set the {@link org.springframework.batch.core.launch.support.SystemExiter}. This class is
...
class GoldinCommandLineJobRunner
{
    ...
    int start(String jobPath, String jobIdentifier, String[] parameters, Set<String> opts) {
        start( [ jobPath ] as String[], jobIdentifier, parameters, opts )
    }
