/**
 * Copied from {@link org.apache.tools.ant.taskdefs.optional.net.FTP}, Ant v1.8.1
 * with minor changes in {@link #execute()} and {@link #listFile}
 *
 ...
 *
 */
package com.goldin.org.apache.tools.ant.taskdefs.optional.net;
...
public class FTP extends Task {
    ...
    protected int transferFiles(final FTPClient ftp, FileSet fs)
        ...
        try {
            if (action == LIST_FILES) {
                ...
                bw = new BufferedWriter(new FileWriter(listing, listingAppend));
            }
    ...
    public void execute() throws BuildException {
        ...
        try {
             ...
             * See http://evgeny-goldin.com/blog/2010/08/18/ant-ftp-task-progress-indicator-timeout/
             */
            ftp = ( verbose ? new com.goldin.org.apache.tools.ant.taskdefs.optional.net.FTPClient( getProject()) :
